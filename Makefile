...
.PHONY: build/pager-email-client

build/pager-email-client:
	mkdir -p ./build
	go build -o ./build/pager-email-client main.go

build: build/pager-email-client

install: build/pager-email-client
	mkdir -p ~/.local/bin
	cp ./build/pager-email-client ~/.local/bin/pager-email-client

docker-image:
	docker build \
		--tag docker.pkg.github.com/tuuturu/pager-email-client/pager-email-client:local \
		.
